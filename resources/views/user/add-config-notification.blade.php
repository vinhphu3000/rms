...
<h4 class="modal-title" id="myModalLabel"><span class="fa fa-plus-circle"></span>  Create new config</h4>
</div>
        ...
        <div class="col-xs-9">
            ...
            <div class="tab-content">
                <div class="tab-pane tab-pane-first" style="display: none">
                    <div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Logic<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select name="logic" style="width: 200px;" >
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Param<span class="required">*</span>
                            </label>
