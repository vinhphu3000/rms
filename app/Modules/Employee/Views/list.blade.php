                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><button type="button" class="btn btn-trans experience" url = "{{ url('employee/experience-popup') }}"><i class="glyphicon glyphicon-certificate" aria-hidden = true></i> Experience</button>
                            </li>
                            <li><button type="button" class="btn btn-trans link-popup" url = "{{ url('employee/import-popup') }}"><i class="glyphicon glyphicon-import" aria-hidden = true></i> Import</button>
                            </li>
                            <li>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php foreach ($result as $key => $item) :?>
                                    <tr>
                                        ...
                                        <td>{{$item->email}}</td>
                                        <td>{{$item->skills}}<br>
                                            <button type="button" class="btn btn-trans view-matrix" url = "{{ url('employee/experience-popup') }}" id = {{$item->id}}><i class="glyphicon glyphicon-edit" aria-hidden = true></i> Skill matrix</button>
                                            </td>
                                        <td><a href="#">View</a></td>
                                    </tr>
                                <?php endforeach; ?>
