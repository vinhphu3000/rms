...
class Employee extends Eloquent
{
   ...
   public static $csv_map_column = [];
    ...
    {
        return $this->belongsTo('App\Modules\Core\Models\EmployeeRole', 'role_id');
    }

    public function position()
    {
        return $this->belongsTo('App\Modules\Core\Models\EmployeePosition', 'position_id');
    }

    public function office()
    {
        return $this->belongsTo('App\Modules\Core\Models\Office', 'office_id');
    }
