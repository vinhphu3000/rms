                                            ...
                                            <ul class="list-inline widget_tally proposal-list">
                                                <li class="proposal-new" style="{{count($proposal_temp) ? '' : 'display:none;' }}">
                                                    ...
                                                    <ul  class="list-inline widget_tally">
                                                        <li style="border: none; text-align: center;"><a href="{{ url('project/proposal/cancel?request_id=' . $request->id . '&project_id=' . $request->project->id) }}" class="btn btn-default">Cancel</a><a href="{{ url('proposal/send?request_id=' . $request->id . '&project_id=' . $request->project->id) }}" class="btn btn-primary">Send</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <div class="x_content">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                    <form class="form-horizontal form-label-left" action="{{ url ('project/request/booking')}}" method="get" >
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 profile_details" employee="{{$item->id}}">
                                                    <div class="well profile_view">
                                                        ...
                                                        <div class="col-xs-12 text-right">
                                                            ...
                                                            <button type="button" employee-id="{{$item->id}}" request-id="{{$request->id}}" url="{{url('project/booking/popup')}}" class="btn btn-primary btn-xs add-proposal">  <i class="fa fa-plus-square"></i> Proposal</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php endforeach; ?>
