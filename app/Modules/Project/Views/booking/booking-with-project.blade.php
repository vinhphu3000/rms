                                        ...
                                        <div class="x_content">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                    <form class="form-horizontal form-label-left" action="{{ url ('project/booking')}}" method="get" >
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 profile_details" employee="{{$item->id}}">
                                                    <div class="well profile_view">
                                                        ...
                                                        <div class="col-xs-12 text-right">
                                                            ...
                                                            <button type="button" employee-id="{{$item->id}}" project-id="{{$request->project->id}}" url="{{url('/project/booking/popup')}}" class="btn btn-primary btn-xs booking">  <i class="fa fa-plus-square"></i> Booking</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php endforeach; ?>
