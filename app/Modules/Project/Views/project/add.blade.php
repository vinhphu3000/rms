            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <select class="form-control" name="status">
                        <?php foreach(\App\Modules\Project\Models\Project::$project_status  as $k => $status): ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <select name="estimate_type" class="form-control">
                        <?php foreach (\App\Modules\Project\Models\Project::$estimate_type as $key => $estimate_type):  ?>
