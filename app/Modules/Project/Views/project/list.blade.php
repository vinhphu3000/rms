                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-striped projects">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$item->estimate}} <small>{{empty(\App\Modules\Project\Models\Project::$estimate_type[$item->estimate_type]) ? '-' : \App\Modules\Project\Models\Project::$estimate_type[$item->estimate_type] }}</small>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-{{\App\Modules\Project\Models\Project::$project_status[$item->status]['class']}} btn-xs">{{\App\Modules\Project\Models\Project::$project_status[$item->status]['lable']}}</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
