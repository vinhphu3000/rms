...
class BookingController extends BaseController {
	...
	*/
    ...
    public function requestBooking(\Illuminate\Http\Request $params)
    {
        ...
        return view('booking.booking-with-requests', $view_data);
    }
    ...
    public function popupBooking(\Illuminate\Http\Request $request)
    {
        ...
        return view('booking.add', ['employee' => $employee, 'request' => $project_request, 'roles' => $roles]);
    }
...
//            }
    ...
    public function reject(\Illuminate\Http\Request $request)
    {
        $id = (int)$request->input('id');
        $project_id = (int)$request->input('project_id');
        return view('booking.reject_reason', ['project_id' => $project_id, 'id' => $id]);
    }
